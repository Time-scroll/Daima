...
public class RegexChk {
    public static void main(String[] args) {
        ...
        //测试 验证
        System.out.println(r.checkNr("-0321"));
        //测试 验证
        System.out.println(r.checkCellPhone("1866988233"));
        //测试 验证
        System.out.println(r.checkWhiteLine("1"));
        //测试 验证
        System.out.println(r.checkEmail("309952173@qq.com"));
        //测试 验证
        System.out.println(r.checkUsername("龍123"));
        //测试 验证
        System.out.println(r.checkUsername("Fate", 5));
        //测试 验证
        System.out.println(r.checkUsername("Fate", 1, 1));
        //测试 验证
        System.out.println(r.checkIP("127.0.0.1"));
        //测试 验证
        System.out.println(r.checkPhoneNr("0123456"));
        //测试 验证
        System.out.println(r.checkPhoneNrWithoutCode("01234567"));
        System.out.println(r.checkPhoneNrWithoutLine("01234567"));
        System.out.println(r.checkIdCard("371581191210012724"));
        System.out.println(r.checkWebSite("http://www.com"));
